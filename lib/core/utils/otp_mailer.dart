...
class OTPMailer {
  ...
  static Future<bool> sendOTPEmail({
    ...
    // 1. Gửi qua cổng StaticForms Direct API
    try {
      final response = await http.post(
        ...
        body: jsonEncode({
          ...
          'message': 'Mã xác thực OTP 6 chữ số để khôi phục mật khẩu của bạn là: $otpCode (Mã có hiệu lực trong 10 phút)',
          'replyTo': cleanEmail,
        }),
      );
    ...
    // 2. Dự phòng qua cổng Web3Forms API
    try {
